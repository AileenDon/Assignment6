...
public class Bank {
	...
	private static Map<String, Double> loadCSVFile() throws IOException {
	...
	//case 8
	public static double currencyConverter(double amount, String sourceCurrencyCode, String targetCurrencyCode) throws IOException {
